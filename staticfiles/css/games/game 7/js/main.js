...
function init(b) {
	...
	if (b) {
		$("#pauseBtn").attr('src',"/static/css/games/game 7/images/btn_pause.svg");
...
function showHelp() {
	...
	if($("#pauseBtn").attr('src') == "/static/css/games/game 7/images/btn_pause.svg" && gameState != 0 && !infobuttonfading) {
		return;
	}
